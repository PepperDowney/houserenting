...
<html>
  ...
  <body>
    ...
    <jsp:useBean id="stuInfo" class="com.student.model.stuInfo"></jsp:useBean>
  	<jsp:setProperty property="*" name="stuInfo"/>
  	<jsp:useBean id="stuServer" class="com.lrxhqujavaee.service.stuInfoservice"></jsp:useBean>
  	<%
  	...
  	out.print(stuInfo.getKc());
  	out.print(stuInfo.getKcs());
  	out.print(stuInfo.getTruename());*/
  	 %>
  	 <%
